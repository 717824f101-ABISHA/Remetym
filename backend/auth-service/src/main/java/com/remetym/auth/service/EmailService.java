...
public class EmailService {
    ...
    public void sendApprovalEmail(String toEmail, String recipientName, String role, String facilityName) {
        String formattedRole = "DHO".equalsIgnoreCase(role) ? "District Health Officer (DHO)" : "PHC Staff";
        ...
        body.append("You can now log in using your registered email (").append(toEmail).append(") at:\n");
    ...
    public void sendRejectionEmail(String toEmail, String recipientName, String role, String facilityName, String reason) {
        String formattedRole = "DHO".equalsIgnoreCase(role) ? "District Health Officer (DHO)" : "PHC Staff";
    ...
    public void sendDeactivationEmail(String toEmail, String recipientName) {
    ...
    public void sendReactivationEmail(String toEmail, String recipientName) {
    ...
    private void sendMail(String toEmail, String subject, String body) {
        String sender = (fromEmail != null && !fromEmail.trim().isEmpty()) ? fromEmail.trim() : "abishasenthil06@gmail.com";
        System.out.println("[EMAIL DISPATCH ATTEMPT] From: " + sender + " | To: " + toEmail + " | Subject: " + subject);
        ...
        try {
            ...
            System.out.println("[EMAIL DISPATCH SUCCESS] Delivered to " + toEmail);
        } catch (Exception e) {
            String smtpErr = "SMTP Delivery Failed to " + toEmail + ": " + e.getMessage();
            System.err.println("[EMAIL SMTP ERROR] " + smtpErr);
